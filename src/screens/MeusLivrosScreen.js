...
// Substitua pelos imports reais das suas imagens
...
// Dados mockados — substitua pelos livros reais do usuário
const MEUS_LIVROS = [
  {
    id: '1',
...
export default function MeusLivrosScreen({ navigation }) {
  const [filtro, setFiltro] = useState('Todos'); // 'Todos' | 'Lendo' | 'Concluídos'
